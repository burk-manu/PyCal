...
class NeonButton(tk.Canvas):
    ...
    def __init__(self, master, text, command,
        ...
        # The neon frame colour for this button.
        self.frame_color = frame_color
        self.font = font
        self.draw_button()
        # Bind click events.
        self.bind("<Button-1>", lambda e: self.command())
        # Optionally, you can bind hover events for subtle effects.
        # In this design, we keep it static.
        self.bind("<Enter>", lambda e: None)
        self.bind("<Leave>", lambda e: None)

    def draw_button(self):
        self.delete("all")
        # Draw a rounded rectangle with a dark grey fill and a neon-coloured outline.
        self.create_round_rect(
            2, 2,
            self.width - 2, self.height - 2,
            r=self.corner_radius,
            fill="#333333",                 # dark grey fill
